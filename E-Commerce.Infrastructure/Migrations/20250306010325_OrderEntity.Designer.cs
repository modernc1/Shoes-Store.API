...
namespace E_Commerce.Infrastructure.Migrations
{
    ...
    [Migration("20250306010325_OrderEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Cart.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Cart.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Cart.CheckoutHistory", b =>
                {
                    b.HasOne("E_Commerce.Domain.Models.Cart.Order", "Order")
            ...
            modelBuilder.Entity("E_Commerce.Domain.Models.Cart.Order", b =>
                {
                    b.HasOne("E_Commerce.Domain.Models.Cart.Address", "ShippingAddress")
                        .WithMany()
                        .HasForeignKey("ShippingAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Commerce.Domain.Models.Identity.AppUser", "User")
                        .WithMany("Orders")
